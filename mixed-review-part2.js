...
// This is the mixed review part 2.
...
function lunch() {
  ...
  let compChoice = randomInt(0, cafes.length - 1);
  let choice;
...
function football() {
	let typeOfScore = readline.question("How did they score (touchdown/td or field goal/fg)? ");
	let score = 0;
	while (typeOfScore.toLowerCase() == "touchdown" || typeOfScore.toLowerCase() == "td" || typeOfScore.toLowerCase() == "field goal" || typeOfScore.toLowerCase() == "fg") {
		typeOfScore = readline.question("How did they score (touchdown/td or field goal/fg)? ");
		if (typeOfScore.toLowerCase() == "touchdown" || typeOfScore.toLowerCase() == "td") {
			score += 7;
		} else if (typeOfScore.toLowerCase() == "field goal" || typeOfScore.toLowerCase() == "fg") {
			score += 3;
		}
	}
	return score;
...
function duckDuckGoose(numOfTimes) {
	let theWord = "Duck";
	for (var i = 0; i <= numOfTimes; i++) {
		console.log(theWord + " " + theWord + " " + "Goose");
	}
}
