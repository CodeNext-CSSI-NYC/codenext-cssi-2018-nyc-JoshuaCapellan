...
if (options[index] == "United States History"){
	...
	let prompt2 = parseInt(readline.question("What year did the War of 1812 end? "));
		if(prompt2 == 1815){
			score++;
			console.log("You got it right!")
	...
	let prompt4 = parseInt(readline.question("How many states did the United States have in 1776? "))
		if(prompt4 == 13){
			score++;
			console.log("You got it right!")
		} else if (prompt4 != 13){
	...
	let  prompt7 = parseInt(readline.question("What year was Pearl Harbor attacked by the Japanese Air Force? "));
		if(prompt7 == 1941){
			score++;
			console.log("You got it right!")
	...
	let prompt9 = parseInt(readline.question("How many stripes are there on the United States Flag? "));
		if(prompt9 == 13){
			score++;
			console.log("You got it right!")
		} else if (prompt9 != 13){
	...
	let q1 = parseInt(readline.question("How many rings did Bill Russell win consecutively? "));
		if(q1 == 8){
			score++;
			console.log("You got it right!")
		} else if (q1 != 8){
	...
	let q2 = parseInt(readline.question("What number did Michael Jordan wear when he returned to the NBA? "));
		if (q2 == 45) {
			score++;
			console.log("You got it right!")
		} else if (q1 != 45){
	...
	let q6 = parseInt(readline.question("What number did Michael Jordan wear before he left the NBA? "));
		if (q6 == 23){
			score++;
			console.log("You got it right!")
		} else if (q6 != 23){
	...
	let q8 = parseInt(readline.question("What is the highest amount of points individually scored in a game in the NBA? "));
		if (q8 == 100){
			score++;
			console.log("You got it right!")
		} else if (q8 != 100){
	...
	let q10 = parseInt(readline.question("How many points is a shot behind the arc worth? "));
		if (q10 == 3){
			score++;
			console.log("You got it right!")
		} else if (q10 != 3){
