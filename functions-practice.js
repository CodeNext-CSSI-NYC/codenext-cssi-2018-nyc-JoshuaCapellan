...
// let num1 = printSquare(3);
// let num2 = printSquare(9);
// let num3 = printSquare(15);
...
// function returnHelloUser (name){
// 	// name = readline.question("User, what is your name? ");
...
// let name1 = returnHelloUser("Josh");
// let name2 = returnHelloUser("Yenry");
// let name3 = returnHelloUser("King");
// console.log(name1);	
// console.log(name2);
// console.log(name3);
...
// function returnAverage(number1, number2){
// 	return console.log("The average of " + (number1 + number2) + " is " + ((number1 + number2)/2) + ".")
// }
